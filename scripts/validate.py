...
for key in ('AKU100K','RAS200','LBESK104','FRDK126','seniorer'):
...
assert sen['items'][0]['age']==55 and sen['items'][-1]['age']>=74
assert all(0<=x['employmentShare']<=100 for x in sen['items'])
